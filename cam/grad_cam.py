# Code taken from https://github.com/jichengyuan/Vision_GNN.git
...
class GradCam:
    def __init__(self, model, feature_module, target_layer_names = None, use_cuda = False):
        self.model = model
        self.feature_module = feature_module
        self.model.eval()
        self.cuda = use_cuda
