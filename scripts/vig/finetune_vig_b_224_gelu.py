...
def run_finetune_vig_b_224_gelu(medical_type, model_type, batch_size, additional_evaluation = False):
    """
...
if __name__ == "__main__":
    ...
    ucsd_classifier = run_finetune_vig_b_224_gelu(medical_types[0], model_types[0], batch_size, additional_evaluation=medical_types[1])
    ori_classifier = run_finetune_vig_b_224_gelu(medical_types[1], model_types[0], batch_size, additional_evaluation=medical_types[0])