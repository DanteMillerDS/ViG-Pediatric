...
import numpy as np
def run_finetune_convs(medical_type, model_type, batch_size, additional_evaluation = False, mean_and_std = False):
    """
   Performs fine-tuning of a conv models on a given medical type and model type.
    ...
    if model_type in ["resnet50", "alexnet", "vgg19", "squeezenet", "densenet", "inception", "googlenet", "mobilenet_v3_large"]:
...
if __name__ == "__main__":
    ...
    batch_size = 128 
    model_types = ["resnet50", "alexnet", "vgg19", "squeezenet", "densenet", "inception", "googlenet", "mobilenet_v3_large"]
    ...
    for i in range(len(model_types)):
        ...
        ori_classifier = run_finetune_convs(medical_types[1], model_types[i], batch_size, additional_evaluation=medical_types[0],mean_and_std = mean_and_std[medical_types[1]])